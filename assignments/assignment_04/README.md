...
. Overall, this assignment strengthened my understanding of software installation on an HPC system without administrative privileges, helped me see how $PATH controls command accessibility, and improved my confidence in writing reusable bash scripts and automating repetitive tasks in a Linux HPC environment.
